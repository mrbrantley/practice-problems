...
var gradePercentage = 69
if (gradePercentage === 100){
    console.log("6. perfect score")
} else if (gradePercentage === 0) {
    console.log("6. no grade available")
...
console.log("7. The data type of variable is: " + typeof testVariable);
...
var password = "YourP@ssword!"
if (password.length >= 12 && password.includes("!")) {
    console.log("8. That is a mighty strong password!");
} else if (password.length >= 8 || password.includes("!")) {
    console.log("8. That password is strong enough.")
} else {
    console.log("8. That is not a valid password.")
};